...
public class MainActivity extends Activity {
    ...
    private BroadcastReceiver updateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (UpdateService.STATE_ACTION_AB_FINISHED) {
                enableReboot = true;
                progress.setIndeterminate(false);
                lastCheckedText = formatLastChecked(null,
                        intent.getLongExtra(UpdateService.EXTRA_MS, 0));
    ...
    public void onButtonRebootClick(View v) {
        ...
        ((PowerManager) getSystemService(Context.POWER_SERVICE)).rebootCustom(PowerManager.REBOOT_SYSTEM);
    }
